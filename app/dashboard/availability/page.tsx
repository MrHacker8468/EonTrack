import { upadateAvailabilityAction } from "@/app/action";
    ...
    return (
        <Card>
            <CardHeader>
                ...
                <CardDescription>In this section, you can view and mannage your availability.</CardDescription>
            </CardHeader>
            <form action={upadateAvailabilityAction}>
                <CardContent className="flex flex-col gap-y-4">
                    {   data.map((item) => (
                            <div key={item.id} className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 items-center"> 
